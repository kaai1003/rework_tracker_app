...
from app_logic.csv_handler import load_json
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.home_frame_entry_label_6 = customtkinter.CTkLabel(self.home_frame,
                                                               ...
                                                               font=customtkinter.CTkFont(size=17, weight="bold"),
                                                               text_color="black")
        self.home_frame_entry_label_6.grid(row=13, column=0, padx=20, pady=5)
        self.process_var = customtkinter.StringVar()
        self.home_frame_entry_6 = customtkinter.CTkComboBox(self.home_frame,
                                                            values=['LAD',
                                                                    'PTA',
                                                                    'Surmoulage',
                                                                    'BOL1',
                                                            ...
                                                            width=300)
        self.home_frame_entry_6.grid(row=14, column=0, padx=20, pady=0)
    ...
    def update_subcategory(self, event):
        ...
        if selected_category in self.failure_data:
            self.home_frame_entry_5_sub.configure(values=list(self.failure_data[selected_category]))
